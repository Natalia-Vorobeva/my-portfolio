import{j as r}from"./index-hyAcAXFU.js";function o({onSwitch:t,currentBackground:e}){const n=["Neon","Aurora","Gradient","Space"],s=["🌈","🌊","💫","🌌"];return r.jsxs("button",{onClick:t,className:`\r
        fixed \r
        bottom-4 right-4\r
