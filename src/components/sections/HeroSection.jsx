...
import { FaReact, FaNodeJs, FaDatabase, FaPalette, FaPenFancy, FaCode } from 'react-icons/fa';
					...
					<div className="hero-left">
						<div className="avatar-section flex items-center gap-8 mb-12 flex-col sm:flex-row sm:text-left text-center">
							<div className="avatar-large relative shrink-0">
								<img
									...
									className={`avatar-img w-48 h-48 rounded-full object-cover border-4 border-primary shadow-[0_15px_40px_rgba(102,126,234,0.3)] transition-opacity duration-300 ${imageLoaded ? 'opacity-100' : 'opacity-0'
										}`}
									loading="lazy"
									decoding="async"
						...
						<div className="hero-text">
							...
							<div className="tech-stack flex gap-4 mb-10 flex-wrap">
								...
								<span className="tech-badge bg-primary/10 px-4 py-2 rounded-full flex items-center gap-3 border border-primary/30 transition-all duration-300 font-medium hover:bg-primary/20">
									<FaCode className="text-primary text-lg" />HTML Email
								</span>
								<span className="tech-badge bg-purple-500/10 px-4 py-2 rounded-full flex items-center gap-3 border border-purple-500/30 transition-all duration-300 font-medium hover:bg-purple-500/20">
  <FaPalette className="text-purple-500 text-lg" />UX/UI
</span>


<span className="tech-badge bg-emerald-500/10 px-4 py-2 rounded-full flex items-center gap-3 border border-emerald-500/30 transition-all duration-300 font-medium hover:bg-emerald-500/20">
  <FaPenFancy className="text-emerald-500 text-lg" />Копирайтинг
</span>
							</div>
						</div>
					</div>
